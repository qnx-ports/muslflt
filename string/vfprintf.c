...
#include <stddef.h>
#include <stdlib.h>
/* Remove FILE definition in wchar.h */
...
/* Must be renamed since our FILE * is incompatible with the system libc */
/* If not renamed, direct calls to vfprintf in the program might end up here */
