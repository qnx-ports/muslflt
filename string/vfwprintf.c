/*
 * Include stdio_shim first to get our shim FILE declaration
 * wchar.h needs this, even though all functions it declares
 * which uses FILE will need to be re-implemented by this
 * library as well
 */
...
/* Override libc narrow printf functions with our own */
#include "xprintf_override.h"
